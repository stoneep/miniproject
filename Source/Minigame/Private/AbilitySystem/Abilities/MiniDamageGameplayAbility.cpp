...
void UMiniDamageGameplayAbility::CauseDamage(AActor* TargetActor)
{
...
FTaggedMontage UMiniDamageGameplayAbility::GetRandomTaggedMontageFromArray(
...
float UMiniDamageGameplayAbility::GetDamageByDamageType(float InLevel, const FGameplayTag& DamageType)
{
